...
export const container =
  "min-h-screen flex items-center justify-center px-4 pt-20 md:pt-29 pb-12 relative bg-gradient-to-br from-[#34B7A5]/60 to-[#234A6A]/25";
...
export const paragraphText =
  "text-gray-700 text-base md:text-lg lg:text-xl leading-relaxed max-w-3xl";
...
export const homeBooksStyles = {
  section:
    "py-20  relative bg-gradient-to-r from-[#6ED6C7]/80 to-[#FBFFD6]/75 ",
  container: "container mx-auto px-4 md:px-6",
  ...
  image:
    "w-full h-full object-contain transition-transform duration-500 group-hover:scale-105 rounded-xl",
  rating:
  ...
  addBtn:
    "w-full flex items-center cursor-pointer justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#6ED6C7] to-[#FBFFD6] text-black rounded-lg hover:shadow-lg transition-all",
...
export const homeAboutStyles = {
  ...
  bookCard:
    "relative bg-white w-60 border-2 border-[#43C6AC]/20 rounded-xl overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-[#43C6AC]/20 h-full flex flex-col",
  bookImageWrapper: "relative h-72 overflow-hidden",
  bookImage:
    "w-full h-full object-fit transition-transform duration-500 group-hover:scale-105",
...
export const booksPageStyles = {
  ...
  bookCard:
    " flex flex-col group bg-white/90 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1",
  imageWrapper:
    "relative aspect-square mb-4 md:mb-6 overflow-hidden rounded-lg md:rounded-xl",
  imageStyle:
    "w-full h-full object-contain transform group-hover:scale-105 transition-transform duration-300",
